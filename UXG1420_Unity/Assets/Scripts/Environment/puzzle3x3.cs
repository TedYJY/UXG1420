...
public class puzzle3x3 : MonoBehaviour
{
    ...
    private void ActivationSurrounding()
    {
        ...
        if (Top != null)
        {
            Top.GetComponent<puzzle3x3>().Activation();
        }

        if (Down != null)
        {
            Down.GetComponent<puzzle3x3>().Activation();
        }

        if (Left != null)
        {
            Left.GetComponent<puzzle3x3>().Activation();
        }

        if (Right != null)
        {
            Right.GetComponent<puzzle3x3>().Activation();
        }
        ...
        if (Tracker == 9)
        {
            ...
            {
                T.GetComponent<puzzle3x3>().enabled = false;
            }
